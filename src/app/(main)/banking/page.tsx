...
export const metadata = { title: "Banking | Dimension Finance" };
...
export default function BankingOverviewPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <PageHeader
        title="Banking"
        description="Visual representation only — Dimension Finance is not connected to any real bank or payment provider."
      />
